let arr = [
    ...
    //         out += "<div class='product-list'><img class='product-item product-img' src=" +
    //           elem.link +
    //           " alt=" +
    //           elem.name +
    //           " ><h2 class='product-list'>" +
    //           elem.description +
    //           "</h2> <h3 class='product-list'>"
    //           + elem.description_2 +
    //           "</h3> <span class='price'><span class='price'>" +
    //           elem.price + "</span> " +
    //           "<input type='number' class='quantity' min='1' value='1'>" +
    //           "<button class=\"btn btn-primary\" onclick=\"addToCart('${elem.name}', '${elem.price}', this.previousSibling.value)\">Додати в кошик</button>" +
    //           " </div>";
    //         i++;
    //       }
    //       if (i % 3 === 0) {
...
function getElements(category) {
    ...
    sortedArr.forEach((elem) => {
      if (category == null || elem.category == category) {
        out +=
          "<div class='product-list'><img class='product-item product-img' src=" +
          elem.link +
          " alt=" +
          elem.name +
          " ><h2 class='product-list'>" +
